...
Only one instance runs at a time (a second launch shows a short notice).
...
Show details · Refresh now · Display profile · Accounts · Always visible · **Settings** (Open / Reload / Reset config, Open log) · Quit
